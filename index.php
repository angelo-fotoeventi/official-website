...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="content">
        	...
        	<div class="box_home" style="margin:0 0 -20px 0;">
        		<a href="chisono.php">
                    <img src="common/theme/img/miniatura_chisono.png" class="miniatura_home" />
                    <div style="margin: -20px 0 0 30px;">
                        <img src="common/theme/img/square.png" />&nbsp;&nbsp;<h2 style="display:inline-block;">CHI SONO</h2>
                    </div>
                    <p class="box_ww">
                    Scopri tutto su di me<br />
                    Il mio lavoro e la fotografia<br />
                    Le competenze ed i servizi
                    </p>
                </a>
            </div>
            <div class="box_home" style="margin:0 -26px -20px -26px;" >
            	<a href="contatto.php">
                    <img src="common/theme/img/miniatura_contatto.png" class="miniatura_home" />
                    <div style="margin: -20px 0 0 30px;">
                        <img src="common/theme/img/square.png" />&nbsp;&nbsp;<h2 style="display:inline-block;">CONTATTO</h2>
                    </div>
                    <p class="box_ww">
                    Contattami via web<br />
                    Manda una mail<br />
                    Cercami tramite telefono
                    </p>
                </a>
            </div>
            <div class="box_home" style="margin:0 0 -20px 0;">
            	<a href="gallery_categorie.php">
                    <img src="common/theme/img/miniatura_gallery.png" class="miniatura_home" />
                    <div style="margin: -20px 0 0 30px;">
                        <img src="common/theme/img/square.png" />&nbsp;&nbsp;<h2 style="display:inline-block;">WEB GALLERY</h2>
                    </div>
                    <p class="box_ww">
                    Scopri tutte le foto<br />
                    Naviga tra le categorie<br />
